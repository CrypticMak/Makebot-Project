updateToDB = (data)=>{
            return fetch(`http://localhost:8080/getTarget`,{
...
class Runtime extends EventEmitter {
    ...
    getTargetForStage () {
        for (let i = 0; i < this.targets.length; i++) {
            ...
            //  const obj = JSON.stringify(target);
            //  const tData = JSON.parse(obj);
            //  console.log("TARGET 1",tData);
             console.log("DATA", target.runtime._editingTarget?.blocks?._blocks);
             const getTarget = target.runtime._editingTarget?.blocks?._blocks;
             console.log("GET TARGET",getTarget);
             updateToDB(getTarget);
